...
def is_phone_number(text):
    # This pattern now accepts numbers with + and international codes, and spaces or dashes as separators
    pattern = re.compile(r'\+?[0-9]{1,3}?[-\s]?[0-9]{1,4}?[-\s]?[0-9]{1,4}?[-\s]?[0-9]{1,9}')
