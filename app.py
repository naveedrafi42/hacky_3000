...
def main():
    try:
        ...
        if any(char.isdigit() for char in full_name):
            ...
            assert is_phone_number(phone_number), f"{phone_number if phone_number else 'The provided'} should be a valid phone number."
        ...
        st.write("Oops! Something went wrong. Don't worry, The Buggy GPT is on the case!")
